...
-- Toggle the Rust language server (rust-analyzer vs rust-glancer) via Nix.
...
if ok_choice and rust_lsp_choice == "rust-glancer" then
    rustaceanvim_config.server.cmd = { "rust-glancer", "lsp" }
end
